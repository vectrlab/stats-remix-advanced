...
sd(sampling) # Display the standard deviation of our observed (generated) sampling distribution
...
standard_error - sd(sampling) # Display the difference between the calculated standard error and our observed standard deviation
```
